      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
        {PROJECTS.map((Projects) => (
          ...
          >
            ...
            transition={{duration:0.5}} 
            className="absolute inset-0 flex flex-col items-center justify-center text-white opacity-0 sm:opacity-100 md:opacity-100 backdrop-blur-lg transition-opacity duration-500 group-hover:opacity-100 sm:group-hover:opacity-100 md:group-hover:opacity-100">
